...
architecture behav of ma is 
    ...
    signal trunc_ln1148_1_reg_612 : STD_LOGIC_VECTOR (20 downto 0);
    signal trunc_ln1148_2_reg_617 : STD_LOGIC_VECTOR (20 downto 0);
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_phi_mux_last_sample_V_phi_fu_137_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_phi_reg_pp0_iter0_last_sample_V_reg_134 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_fu_469_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal add_ln691_fu_477_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal t_fu_519_p2 : STD_LOGIC_VECTOR (25 downto 0);
    signal sext_ln703_fu_489_p0 : STD_LOGIC_VECTOR (12 downto 0);
    signal sext_ln703_fu_489_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal sext_ln703_1_fu_493_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal ret_V_fu_497_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal shl_ln_fu_507_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal sext_ln703_2_fu_515_p1 : STD_LOGIC_VECTOR (25 downto 0);
    signal sub_ln1148_fu_539_p2 : STD_LOGIC_VECTOR (25 downto 0);
    signal sub_ln1148_1_fu_565_p2 : STD_LOGIC_VECTOR (20 downto 0);
    signal r_V_fu_570_p3 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_2_fu_586_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln415_fu_594_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal trunc_ln1_fu_576_p4 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    accum_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                accum <= ap_const_lv26_0;
            else
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((tmp_fu_469_p3 = ap_const_lv1_0) and (ap_const_logic_1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_1_reg_607 <= t_fu_519_p2(25 downto 25);
                trunc_ln1148_1_reg_612 <= sub_ln1148_fu_539_p2(25 downto 5);
                trunc_ln1148_2_reg_617 <= t_fu_519_p2(25 downto 5);
            end if;
        end if;
    end process;
    ...
    add_ln691_fu_477_p2 <= std_logic_vector(unsigned(j) + unsigned(ap_const_lv6_1));
    ...
    ap_phi_mux_last_sample_V_phi_fu_137_p4_assign_proc : process(memory_V_1, ap_phi_reg_pp0_iter0_last_sample_V_reg_134, tmp_fu_469_p3)
    begin
        if ((tmp_fu_469_p3 = ap_const_lv1_1)) then 
            ap_phi_mux_last_sample_V_phi_fu_137_p4 <= memory_V_1;
        elsif ((tmp_fu_469_p3 = ap_const_lv1_0)) then 
            ap_phi_mux_last_sample_V_phi_fu_137_p4 <= ap_const_lv13_0;
        else 
            ap_phi_mux_last_sample_V_phi_fu_137_p4 <= ap_phi_reg_pp0_iter0_last_sample_V_reg_134;
        end if; 
    end process;

    ap_phi_reg_pp0_iter0_last_sample_V_reg_134 <= "XXXXXXXXXXXXX";
    ap_reset_idle_pp0 <= ap_const_logic_0;
    ap_return <= std_logic_vector(unsigned(zext_ln415_fu_594_p1) + unsigned(trunc_ln1_fu_576_p4));
    r_V_fu_570_p3 <= 
        sub_ln1148_1_fu_565_p2 when (tmp_1_reg_607(0) = '1') else 
        trunc_ln1148_2_reg_617;
    ret_V_fu_497_p2 <= std_logic_vector(signed(sext_ln703_fu_489_p1) - signed(sext_ln703_1_fu_493_p1));
        sext_ln703_1_fu_493_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ap_phi_mux_last_sample_V_phi_fu_137_p4),14));

        sext_ln703_2_fu_515_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(shl_ln_fu_507_p3),26));

    sext_ln703_fu_489_p0 <= sample;
        sext_ln703_fu_489_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln703_fu_489_p0),14));

    shl_ln_fu_507_p3 <= (ret_V_fu_497_p2 & ap_const_lv8_0);
    sub_ln1148_1_fu_565_p2 <= std_logic_vector(unsigned(ap_const_lv21_0) - unsigned(trunc_ln1148_1_reg_612));
    sub_ln1148_fu_539_p2 <= std_logic_vector(unsigned(ap_const_lv26_0) - unsigned(t_fu_519_p2));
    t_fu_519_p2 <= std_logic_vector(unsigned(accum) + unsigned(sext_ln703_2_fu_515_p1));
    tmp_2_fu_586_p3 <= r_V_fu_570_p3(7 downto 7);
    tmp_fu_469_p3 <= j(5 downto 5);
    trunc_ln1_fu_576_p4 <= r_V_fu_570_p3(20 downto 8);
    zext_ln415_fu_594_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_2_fu_586_p3),13));
end behav;
